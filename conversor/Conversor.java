...
public class Conversor {
	...
	private void executarConversor() {
		...
		if (type == "Conversor de moeda") {
			...
			String dinheiro = (JOptionPane.showInputDialog(null,
					"Escolha a moeda para a qual você deseja girar seu dinheiro", "Moeda",
			...
			try {
				...
				if (escolha == JOptionPane.YES_OPTION) {
					...
					JOptionPane.showMessageDialog(frame, "Programa finalizado", "Message",
				...
				JOptionPane.showMessageDialog(null, "Erro: Valor digitado não é um número válido", "Erro",
						JOptionPane.ERROR_MESSAGE);
				executarConversor();
			}

		} else {
			String tipoDeConversor = (JOptionPane.showInputDialog(null, "Escolha uma opção:",
					"Conversor de temperatura",
					JOptionPane.PLAIN_MESSAGE, null,
					new Object[] { "Celsius para Fahrenheit", "Fahrenheit para Celsius" }, null)).toString();
